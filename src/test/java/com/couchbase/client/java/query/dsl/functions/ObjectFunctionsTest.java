...
import static com.couchbase.client.java.query.dsl.functions.ObjectFunctions.*;
...
public class ObjectFunctionsTest {
    ...
    public void testObjectNames() throws Exception {
        ...
        Expression e3 = objectNames(JsonObject.jo());
    ...
    public void testObjectPairs() throws Exception {
        ...
        Expression e3 = objectPairs(JsonObject.jo());
    ...
    public void testObjectValues() throws Exception {
        ...
        Expression e3 = objectValues(JsonObject.jo());
